...
const char* ssid = "your SSID Hotspot";
const char* password = "your Password Hotspot";
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
...
void loop() {
  ...
  if (readsuccess) {
    ...
    String server = "ipaddress/newrfid/getUID.php";
    http.begin(client, server);
//    http.begin(client, "http://192.168.51.87/newrfid/getUID.php");  //Specify request destination
